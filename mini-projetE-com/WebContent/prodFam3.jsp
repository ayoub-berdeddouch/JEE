...
<body>
  ...
  <!-- Hereeeeeeeeeeeeeeee Noootreee Codeeeee -->  
        ...
        <% 
            ...
            ResultSet resultset = 
                statement.executeQuery("select * from produit where famPro = 3 ") ; 
        %>
        <br>
        <br>
        <br> 
...
<div align="center" class="container">
  ...
  <table class="items-list">
   ...
   <tbody>
      ...
      <tr class="item first">
        <td class="thumb"><a href ="./picFam3/<%= resultset.getInt(1) %>.jpg" class="thumbnail" data-toggle="lightbox"><img src="./picFam3/<%= resultset.getInt(1) %>.jpg" class="img-rounded" alt="phone" width="304" height="236"></a></td>
