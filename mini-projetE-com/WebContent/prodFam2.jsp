...
<body>
    ...
    <header data-offset-top="500" data-stuck="600"><!--data-offset-top is when header converts to small variant and data-stuck when it becomes visible. Values in px represent position of scroll from top. Make sure there is at least 100px between those two values for smooth animation-->
      ...
      <div class="container">
        <a class="logo" href="acceuile.jsp"><img src="./pics/eCommerce.jpg" alt="home"></a>
      </div>
  ...
  <!-- Hereeeeeeeeeeeeeeee Noootreee Codeeeee -->  
        ...
        <% 
            ...
            ResultSet resultset = 
                statement.executeQuery("select * from produit where famPro = 2 ") ; 
        %>
        <br>
        <br>
        <br> 
...
<div align="center" class="container">
  ...
  <table class="items-list">
   ...
   <tbody>
      ...
      <tr class="item first">
        <td class="thumb"><a href ="./picFam2/<%= resultset.getInt(1) %>.tif" class="thumbnail" data-toggle="lightbox"><img src="./picFam2/<%= resultset.getInt(1) %>.tif" class="img-rounded" alt="WomenWear" width="304" height="236"></a></td>
